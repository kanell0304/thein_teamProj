 ...
 */
class MyDataPipelineIntegrationTest {
    ...
    void setUp() {
        ...
        MyDataPipeline myDataPipeline = new MyDataPipeline(
                new UserMyDataCleaner(),
                new MerchantUsageProcessor(merchantNameNormalizer),
                new MerchantPlaceClassifier(merchantPlaceMatcher)
        );
