...
| 🚀 배포  | 📘 API | 🗂️ 프로젝트 문서 | 📖 기술 보고서 | 🎨 화면 설계 |
| :-----: | :-----: | :-----: | :-----: | :-----: |
| [서비스 실행](https://d3syj51ll6yq4a.cloudfront.net/) | [Swagger](https://d1llv9lskrx5vw.cloudfront.net/swagger-ui.html) | [Notion](https://app.notion.com/p/momeokji/1c72e073c0e3837997f5017a13efd3c7) | [문서 보기](https://app.notion.com/p/d0c2e073c0e3821a9aaf019efb07b479) | [Figma](https://www.figma.com/design/9RbAxoRILDrcQTgY634Dkd/%EC%A0%9C%EB%AA%A9-%EC%97%86%EC%9D%8C?node-id=16-2947&t=gSVer82mZtyRsdFu-1) |
...
| 기능             | 핵심 동작                                                                            | 상세 문서                                                                                     |
| ---------------- | ------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------- |
| UI/UX            | 모바일형 바텀시트, 단계형 입력, 드래그·키보드·접근성 상태 대응                       | [모먹지 UI/UX 구현](https://app.notion.com/p/3aa2e073c0e381c2b4abcb6a741e9e36)                |
| 친구·실시간 채팅 | UID 친구 요청, 방 생성·8자리 코드 입장·초대·나가기, REST 이력과 STOMP 메시지         | [채팅방 구성·실시간 채팅 프로세스](https://app.notion.com/p/3aa2e073c0e381db8707c2c7abcdc33a) |
| 채팅 키워드      | 최근 2시간 대화와 DB 음식 사전을 분석해 유형별 최대 7개 노출, 전체 최대 3개 선택     | [채팅 키워드 추출 프로세스](https://app.notion.com/p/3a72e073c0e3804886a1f4f6ddc2d3e1)        |
| 공통·개인 옵션   | 모임 공통 설정과 참가자별 조건을 분리하고 전원 제출 시 추천 자동 시작                | [공통·개인 옵션 처리 프로세스](https://app.notion.com/p/3aa2e073c0e38036a843c81de43e7954)     |
...
| AI 추천          | 직접 입력·MyData를 정규화해 결합하고 카카오 실제 후보 중 OpenAI가 식당 3곳 선택      | [데이터 기반 AI 추천 프로세스](https://app.notion.com/p/3a72e073c0e380baadc9ec0874ce1701)     |
| 투표·최종 확정   | 1~4개 복수 선택, 재추천, 동률·무투표 판정, 최종 공지 저장과 실시간 전송              | [투표·재추천·최종 확정 프로세스](https://app.notion.com/p/3aa2e073c0e381cab625f0e7159e711f)   |

## 🔄 서비스 흐름

### 사용자 화면 흐름

![모먹지 사용자 화면 흐름](docs/readme_img/flow.jpg)

_사용자가 채팅방에서 모임을 시작해 조건을 입력하고 결과를 확정하는 화면 순서를 요약한 이미지입니다._
...
| 경계            | 책임                                                             |
| --------------- | ---------------------------------------------------------------- |
| REST            | 로그인, 친구·채팅방 명령, 메시지 이력, 모임·조건·투표·상태 조회  |
| STOMP WebSocket | 새 메시지, 모임 초대, 제출·추천·득표 현황, 최종 공지             |
